...
Commands:
  ...
  package     Build, sign, notarize, staple, and verify (live approval is separate).
...
package_distribution() {
    ...
    codesign --force --identifier dev.spaceo.dmg --timestamp \
        --sign "$SIGNING_IDENTITY" "$working_artifact"
    codesign --verify --strict -R "$(publisher_requirement dev.spaceo.dmg)" "$working_artifact"
