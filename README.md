...
<h1 align="center">Your agent’s screen. Your Mac stays yours.</h1>

<p align="center">
  SpaceO gives AI agents headless macOS displays for working in real apps.<br>
  Keep using your screen while agents work on theirs.
</p>
...
> The existing source-only prerelease is not a verified binary distribution. Build from source
> below; approved DMGs will appear on the [Releases page](https://github.com/ParthJadhav/SpaceO/releases).
